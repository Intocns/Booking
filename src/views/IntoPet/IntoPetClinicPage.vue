                        ...
                        <div class="d-flex align-center gap-4">
                            ...
                            <div class="helper">
                                ...
                                <div class="tooltip-content">
                                    <ul>
                                        <li>현장 데스크(관리자)로 설정할 경우, 현장 데스크에서 담당 수의사를 지정합니다. 검진명이나 진료과목명으로 진료실을 등록한 경우, 현장 데스크(관리자) 항목을 선택하시면 관리가 용이합니다.
                                            <br/>단, 해당 진료실은 모든 예약이 관리자 확인 후 승인 가능한 상태로 설정됩니다.</li>
